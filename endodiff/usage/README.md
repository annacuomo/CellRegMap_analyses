...
* Step1: run_association (discovery)
  ...
  *   For example, run [association script](../endodiff/usage/scripts/association_test_for_one_gene.py) for all gene-SNP pairs (in cis) - you can use a [runner script] to submit one job per gene
